...
export function Composer({
  ...
  // Auto-dismiss the keyboard only when the field is EMPTY (tap-and-walked-
  // away). NEVER while the user is mid-compose — a reflective answer has
  // long thinking pauses, and stealing the keyboard mid-thought is hostile.
      ...
      <View style={[styles.bar, { paddingBottom: 14 + bottomInset }]}>
        ...
        >
          <TextInput
            ...
            onFocus={() => {
              setFocused(true);
              // Arm the empty-field idle dismiss; once the user types
...
const styles = StyleSheet.create({
  ...
  input: {
    ...
    fontSize: 17,
    color: theme.text,
    // Rest at two rows (2 × lineHeight 24 + paddingVertical 11×2 = 70) so a
    // second line is always visible — the web textarea doesn't reliably
    // auto-grow on the first wrap.
    minHeight: 70,
    maxHeight: 140,
    lineHeight: 24,
