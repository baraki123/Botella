...
const rtlMarkdownStyles = {
  ...
  paragraph: {
    ...
    // Hebrew line stays pinned to the LEFT (flex-start of an LTR row)
    // even though its own textAlign is "right". alignItems: flex-end is
    // a View prop RNW always applies — it pushes the textgroup to the
    // right edge so short standalone lines hug the right like long ones.
